...
**Protocol Escape**의 맵은 4개의 스테이지와 최종 보스전으로 구성되어 있습니다. 각 맵은 고유의 테마와 환경, 적 배치, 보스 메카닉을 제공합니다.

### 스테이지 1: 섹터1
- **테마**: 플레이어가 처음으로 적을 마주치는 실험실 창고
- **특징**: 콘크리트 구조물과 철판으로 이루어진 2층 난간 구간
- **적 유형**: 기본 외계 몬스터.
...
### 스테이지 2: 공기 정화소
- **테마**: 거대한 환풍기와 굴둑으로 이루어진 정화소.
- **특징**: 넓은 공간, 컨테이너 난간을 이용한 점프맵.
- **적 유형**: 강화 외계 몬스터.
...
### 스테이지 3: 지하 광산
- **테마**: 연구소의 자원을 조달하는 지하 광산.
- **특징**: 폐쇄적 구조, 수많은 적.
- **적 유형**: 기본 외계 몬스터, 강화 외계 몬스터.
  
![Image Alt Text](images/스테이지3_이미지.PNG)
