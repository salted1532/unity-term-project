...
namespace SlimUI.ModernMenu{
	public class UIMenuManager : MonoBehaviour {
		...
		public void PlaySound(){
			SoundManager.Instance.PlaySound2D("BGM_MusicSample", 0f, true, SoundType.BGM);
		}
		...
		public void PlaySFXHover(){
			SoundManager.Instance.PlaySound2D("EFFECT_Click_Punch");
		}

		public void PlaySwoosh(){
			SoundManager.Instance.PlaySound2D("EFFECT_Click_Whoosh");
		}
